...
# proxies = {'http':'http://119.254.94.93:8088'}
...
page_url = 'https://www.manhuadui.com/manhua/touxingjiuyuetian/5215.html'
...
find_chapterImages = re.compile('var chapterImages = "(.*?)"', re.S)
chapterImages = re.findall(find_chapterImages, str(myhtml))[0]
# print(chapterImages)

# print(base64.b64decode(chapterImages))

# comic_url = base64.b64decode(chapterImages).decode('gbk')
...
# comic_url = myhtml.xpath("//div[@class='mh-works-title clearfix']/h4/a/@href") 
# print(comic_url)
